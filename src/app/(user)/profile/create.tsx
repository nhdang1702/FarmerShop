...
import { useInsertProfile, useMyProfile, useUpdateProfile } from '@/api/profiles';
...
const CreateProfileScreen = () => {
  ...
  const onCreate = async () => {
    ...
    insertProfile(
      { name, address, phone: parseInt(phone) },
      {
        onSuccess: () => {
          resetFields();
          router.back();
  ...
  return (
    ...
    <View style={styles.container}>
        <Stack.Screen options={{title: 'Điền thông tin của bạn'}}/>
        ...
        <Button onPress={onCreate} text={'Cập nhật'}/>
